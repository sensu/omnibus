  ...
  module S3Helpers
    ...
    module InstanceMethods
      ...
      def store_object(key, content, content_md5, acl)
        ...
        # FIXME: For reasons yet unknown, the base64 encoded MD5 checksums
        # generated by omnibus on windows are wrong, raising Aws::S3::Errors::BadDigest
        # For now, we'll work around this by skipping content_md5 on that platform.
        obj_options.merge!(content_md5: to_base64_digest(content_md5)) unless Ohai["platform_family"] == "windows"
        bucket.put_object(obj_options)
        true
      end
